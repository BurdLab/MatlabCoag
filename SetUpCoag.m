...
param.n_sections = 10;            % Nmber of sections
param.kernel     = 'KernelBrown'; % Kernel type
param.d0         = 20e-4;        % Diameter of unit particle [cm]
...
param.t_final = 20.0;             % Final time for integrations [d]
